...
Write-Host ""
Write-Host "🏥 Step 2: Creating Sample Hospitals" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "🏛️ Step 3: Creating Sample Organizations" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "🔍 Step 4: Verifying Data Creation" -ForegroundColor Yellow
